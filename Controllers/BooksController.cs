...
namespace BooksCatalogue.Controllers
{
    ...
    {
        private string apiEndpoint = "https://smbooksapi.azurewebsites.net/api/books/";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,Synopsis,ReleaseYear")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
